...
workdir = '/Users/jacob.carlin/Documents/Data/downburst_1d/'
...
#print('Model source directory: ', os.getcwd())
...
lut_path = workdir + nm.lut_path
twolayer_lut_path = workdir + nm.twolayer_lut_path
write_netcdf = nm.write_netcdf
netcdf_path = workdir + nm.netcdf_path
verbose = nm.verbose
ar_opt = nm.ar_opt
